...
function wrapEventsAction(sourceName, action, verb) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield _allEmit('before');
        yield Promise.all(this.entities.map(entity => entity[action](sourceName, {
            skipEvents: true,
        })));
        yield _allEmit('after');
    });
}
const setProxyProps = {
    get(target, prop) {
...
class Set {
    ...
    persist(sourceName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield _allEmit('Persist', 'before');
            yield _allEmit('Validate', 'before');
            ...
            yield _allEmit('Validate', 'after');
            yield wrapEventsAction.call(this, sourceName, 'persist', _.map(suffixes, suffix => `Persist${suffix}`));
            yield _allEmit('Persist', 'after');
            return this;
        });
    }
    /**
    ...
    fetch(sourceName) {
        return __awaiter(this, void 0, void 0, function* () {
            yield wrapEventsAction.call(this, sourceName, 'fetch', 'Fetch');
            return this;
        });
    }
    /**
    ...
    destroy(sourceName) {
        return __awaiter(this, void 0, void 0, function* () {
            yield wrapEventsAction.call(this, sourceName, 'destroy', 'Destroy');
            return this;
        });
    }
    /**
