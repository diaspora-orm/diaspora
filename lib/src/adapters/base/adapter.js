 ...
 * @author gerkin
 */
const { OPERATORS, CANONICAL_OPERATORS, QUERY_OPTIONS_TRANSFORMS, iterateLimit, remapIO, } = require('./adapter-utils');
/**
...
class DiasporaAdapter extends SequentialEvent {
    ...
    constructor(classEntity) {
        ...
        this.on('ready', () => {
            ...
            this.state = 'error';
            Diaspora.logger.error('Error while initializing:', _.pick(err, Object.getOwnPropertyNames(err)));
            this.error = err;
        });
    }
    /**
