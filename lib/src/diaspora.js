...
const getDefaultFunction = (identifier) => {
...
const Diaspora = {
    ...
    default(entity, modelDesc) {
        ...
        return _.defaults(entity, _.mapValues(modelDesc, (fieldDesc, field) => this.defaultField(entity[field], fieldDesc)));
    },
    /**
    ...
    defaultField(value, fieldDesc) {
        ...
        if (!_.isUndefined(value)) {
            ...
            out = _.isFunction(fieldDesc.default) ? fieldDesc.default() : getDefaultFunction(fieldDesc.default);
        }
            ...
            get(target, key) {
                ...
                if (_.isString(key)) {
                    ...
                    if (null !== method) {
                        ...
                        const methodObj = _.mapKeys(method.slice(0, 3), (val, key) => (['full', 'query', 'number'][key]));
                        return wrapDataSourceAction(target[key], methodObj.query, target);
                    }
                }
                return target[key];
            },
