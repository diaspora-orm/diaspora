...
const Diaspora = {
	 ...
	 * @description Create a data source (usually, a database connection) that may be used by models
	 * @memberof Diaspora
	 * @public
	 * @author gerkin
	 ...
	 * @description Register a new adapter and make it available to use by models
	 * @memberof Diaspora
	 * @public
	 * @author gerkin
	...
	registerAdapter( label, adapter ) {
		...
		if(!adapter instanceof Diaspora.components.DiasporaAdapter){
	 ...
	 * @description Hash containing all available models
	 * @memberof Diaspora
	 * @public
	 * @author gerkin
	 ...
	 * @description Hash containing all available data sources
	 * @memberof Diaspora
	 * @private
	 * @author gerkin
	 ...
	 * @description Hash containing all available adapters. The only universal adapter is `inMemory`
	 * @memberof Diaspora
	 * @private
	 * @author gerkin
	 ...
	 * @description Dependencies of Diaspora
	 * @memberof Diaspora
	 * @private
	 * @author gerkin
	 */
...
/**
 * @type {Object}
 * @description List of components exposed by Diaspora
 * @memberof Diaspora
 * @private
 * @author gerkin
 */
Diaspora.components = {
	Entity:          require( 'lib/entityFactory' )( null, {}, null ),
	Set:             require( 'lib/set' ),
	Model:           require( 'lib/model' ),
	ValidationError: require( 'lib/validationError' ),
	DiasporaAdapter: require('lib/adapters/baseAdapter'),
	DataStoreEntity: require('lib/dataStoreEntities/baseEntity'),
};

// Register available built-in adapters
Diaspora.registerAdapter( 'inMemory', require( 'lib/adapters/inMemoryAdapter' ));
// Register browserStorage only if in browser
if ( process.browser ) {
	Diaspora.registerAdapter( 'browserStorage', require( 'lib/adapters/browserStorageAdapter' ));
}