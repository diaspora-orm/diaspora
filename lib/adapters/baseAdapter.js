...
const OPERATORS = {
	$exists( entityVal, targetVal ) {
		return targetVal === !_.isUndefined( entityVal );
	},
	$equal( entityVal, targetVal ) {
		return !_.isUndefined( entityVal ) && entityVal === targetVal;
	},
	$diff( entityVal, targetVal ) {
		return !_.isUndefined( entityVal ) && entityVal !== targetVal;
	},
	$less( entityVal, targetVal ) {
		return !_.isUndefined( entityVal ) && entityVal < targetVal;
	},
	$lessEqual( entityVal, targetVal ) {
		return !_.isUndefined( entityVal ) && entityVal <= targetVal;
	},
	$greater( entityVal, targetVal ) {
		return !_.isUndefined( entityVal ) && entityVal > targetVal;
	},
	$greaterEqual( entityVal, targetVal ) {
		return !_.isUndefined( entityVal ) && entityVal >= targetVal;
	},
};
