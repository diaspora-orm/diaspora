...
* **types/ModelDescription:** Fixed missing import of lodash ([0daf2b8](https://github.com/diaspora-orm/diaspora/commit/0daf2b8))
...
* chore: run `npm install` to clean the package-lock, fix version script ([fd7e0ad](https://github.com/diaspora-orm/diaspora/commit/fd7e0ad))
* chore: updated packages dependencies ([26ff239](https://github.com/diaspora-orm/diaspora/commit/26ff239))
* chore(LICENSE): Apply new licence to package.json ([8a463dc](https://github.com/diaspora-orm/diaspora/commit/8a463dc))
* chore(LICENSE): Changed license from GPLv3 to Apache2.0 ([9ebd70a](https://github.com/diaspora-orm/diaspora/commit/9ebd70a))
* chore(package): Removed unused dependencies ([7f34ebd](https://github.com/diaspora-orm/diaspora/commit/7f34ebd))
* chore(package): update @types/node to version 10.11.6 ([b004296](https://github.com/diaspora-orm/diaspora/commit/b004296))
* chore(package): update commitizen to version 3.0.2 ([a4eaaf3](https://github.com/diaspora-orm/diaspora/commit/a4eaaf3))
* chore(package): update conventional-changelog-cli to version 2.0.11 ([efacd24](https://github.com/diaspora-orm/diaspora/commit/efacd24))
* chore(package): update jest-extended to version 0.11.0 ([4e0adc0](https://github.com/diaspora-orm/diaspora/commit/4e0adc0))
* chore(package): update jest-extended to version 0.9.0 ([e419e6e](https://github.com/diaspora-orm/diaspora/commit/e419e6e))
* chore(package): update lockfile package-lock.json ([30c0427](https://github.com/diaspora-orm/diaspora/commit/30c0427))
* chore(package): update lockfile package-lock.json ([268b62c](https://github.com/diaspora-orm/diaspora/commit/268b62c))
* chore(package): update lockfile package-lock.json ([a0a07f4](https://github.com/diaspora-orm/diaspora/commit/a0a07f4))
* chore(package): update lockfile package-lock.json ([971cd63](https://github.com/diaspora-orm/diaspora/commit/971cd63))
* chore(package): update lockfile package-lock.json ([828c62a](https://github.com/diaspora-orm/diaspora/commit/828c62a))
* chore(package): update lockfile package-lock.json ([5b5b739](https://github.com/diaspora-orm/diaspora/commit/5b5b739))
* chore(package): update lockfile package-lock.json ([6a8e297](https://github.com/diaspora-orm/diaspora/commit/6a8e297))
* chore(package): update lockfile package-lock.json ([9ed13a3](https://github.com/diaspora-orm/diaspora/commit/9ed13a3))
* chore(package): update logform to version 1.10.0 ([45eee2c](https://github.com/diaspora-orm/diaspora/commit/45eee2c))
* chore(package): update ts-jest to version 23.10.4 ([5d6849d](https://github.com/diaspora-orm/diaspora/commit/5d6849d))
* chore(package): update typedoc to version 0.12.0 ([0f14bf0](https://github.com/diaspora-orm/diaspora/commit/0f14bf0))
* chore(package): update typedoc to version 0.13.0 ([dfbd398](https://github.com/diaspora-orm/diaspora/commit/dfbd398))
* chore(README): Added link to Browserstack ([b63f91d](https://github.com/diaspora-orm/diaspora/commit/b63f91d))
* test(AdapterEntity): Added test for id property ([87fd8b1](https://github.com/diaspora-orm/diaspora/commit/87fd8b1))
* test(ts-jest): Updated config to use presets ([69af20e](https://github.com/diaspora-orm/diaspora/commit/69af20e))
* test(unit-test): Fixed unit tests paths & imports ([c0e0fbc](https://github.com/diaspora-orm/diaspora/commit/c0e0fbc))
* build(package): Catch up latest versions to resync with greenkeeper ([2eb29dd](https://github.com/diaspora-orm/diaspora/commit/2eb29dd))
* build(package): Use local rollup for build (with `npx`) ([f586a9c](https://github.com/diaspora-orm/diaspora/commit/f586a9c))
* build(package): Use local rollup for build (with `npx`) ([438e68c](https://github.com/diaspora-orm/diaspora/commit/438e68c))
* build(rollup): Changed rollup builds for IIFE & ESM on browser, & ESM only for node ([c717919](https://github.com/diaspora-orm/diaspora/commit/c717919)), closes [pstephan1187/vue-datatable#47](https://github.com/pstephan1187/vue-datatable/issues/47)
* build(rollup): Replaced rollup-plugin-uglify with rollup-plugin-terser ([41ef4ae](https://github.com/diaspora-orm/diaspora/commit/41ef4ae))
* docs: Regenerated docs ([34cd207](https://github.com/diaspora-orm/diaspora/commit/34cd207))
* docs: Removed all docs directories ([458f9da](https://github.com/diaspora-orm/diaspora/commit/458f9da))
* docs(README): Added Browserstack logo ([5c9ebad](https://github.com/diaspora-orm/diaspora/commit/5c9ebad))
* fix: The Shame WebApi fix ([778113c](https://github.com/diaspora-orm/diaspora/commit/778113c))
* fix(Diaspora): Fixed target-env-specific imports ([ea7bbf9](https://github.com/diaspora-orm/diaspora/commit/ea7bbf9))
* fix(Model): Fixed !st param `source` for insert actions. Now use type parameter ([a25df9b](https://github.com/diaspora-orm/diaspora/commit/a25df9b))
* refactor: Created more namespaces for Adapters & EntityTransformers ([cfa6611](https://github.com/diaspora-orm/diaspora/commit/cfa6611))
* refactor(Test): Moved unit tests to `test/unit-test` ([ac30115](https://github.com/diaspora-orm/diaspora/commit/ac30115))
* feature(AdapterEntity): Added id property accessor. ([94f972d](https://github.com/diaspora-orm/diaspora/commit/94f972d))
* Merge branch 'staging' into develop ([64c67c1](https://github.com/diaspora-orm/diaspora/commit/64c67c1)), closes [#23](https://github.com/diaspora-orm/diaspora/issues/23) [#27](https://github.com/diaspora-orm/diaspora/issues/27) [#28](https://github.com/diaspora-orm/diaspora/issues/28)
